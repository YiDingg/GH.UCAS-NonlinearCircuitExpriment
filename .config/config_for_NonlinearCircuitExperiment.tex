...
\usepackage{fancyhdr}   %宏包：页眉页脚设置
    ...
    %\rhead{《线性电路实验》实验报告}    
    \lhead{\small \faGithub\ \href{https://github.com/YiDingg/GH.UCAS-NonlinearCircuitExpriment}{\color{black} https://github.com/YiDingg/GH.UCAS-NonlinearCircuitExpriment}}
